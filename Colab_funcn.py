...
deviceVectorCollection = SampleDB['devicefeedVectors']
deviceClusterCollection = SampleDB['DevicefeedClusters']

newsVectorCollection = SampleDB['newsfeedVectors']
newsTSpentCollection = SampleDB['newsfeedTSpent']
newsScoreCollection = SampleDB['newsfeedScores']
deviceNotiClustersCollection = SampleDB['DevicefeedClusters']
