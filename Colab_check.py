...
deviceVectorCollection = SampleDB['deviceVectors_ch']
deviceClusterCollection = SampleDB['notiDeviceClusters_ch']

newsVectorCollection = SampleDB['newsVectors_ch']
newsTSpentCollection = SampleDB['newsTSpent_ch']
newsScoreCollection = SampleDB['newsScores_ch']
deviceNotiClustersCollection = SampleDB['notiDeviceClusters_ch']
